...
def callMain(in_channel, first_out_channel, trn_folder, val_folder, gold_folder, lr, patience, min_delta, model_name,
    ...
    losses, val_losses = trn.train(in_channel, first_out_channel, trn_folder, val_folder, gold_folder, lr, patience, min_delta,model_name,initial_model, alpha, cont, cont_model)
